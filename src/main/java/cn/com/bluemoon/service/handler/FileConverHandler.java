package cn.com.bluemoon.service.handler;
...
import cn.com.bluemoon.service.office.impl.OfficeConService;
import cn.com.bluemoon.util.FileExtConstant;
import cn.com.bluemoon.util.FileUtils;
import cn.com.bluemoon.util.PropertiesUtil;
 ...
 * 类描述：文件转换处理<br>
 * 创建时间：2017年1月16日 10:36:30<br>
 * @version v1.0
 *
 */
@Service(value="fileConverHandler")
public class FileConverHandler {
     ...
     * swftools目录
     */
    private static final String SWFTOOLS_PATH = "E:/SWFTools/pdf2swf.exe";

    /**
     * swftools目录
     */
    private static final String LANGUAGEDIR_PATH = "";
