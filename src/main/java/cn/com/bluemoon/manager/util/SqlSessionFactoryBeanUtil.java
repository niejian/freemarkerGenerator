package cn.com.bluemoon.manager.util;
 ...
 * @version $Id$
 */
public class SqlSessionFactoryBeanUtil implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {

  private static final Log logger = LogFactory.getLog(SqlSessionFactoryBeanUtil.class);
