 ...
 *
 */
public class PoVoGenerateUtil_v2 {
	
	
	//指定Javabean模板的位置
	private String javaBeanTemplateName = "javaBean.ftl";
	// xmlMapper模板文件位置
	private String xmlMapperTemplateName = "XmlMapper.ftl";
	// javaMapper模板文件位置
	private String javaMapperTemplateName = "JavaMapper.ftl";
	// Controller模板文件位置
	private String controllerMapperTemplateName = "ControllerGen.ftl";

	// 模板文件所在位置
	private String templateLocation = this.getClass().getResource("").getPath();
...
//	            outPutFile.createNewFile();
	 ...
	 * @param beanName 需要转换的实体名，如果querySql是视图，这个参数必填
	 */
	public void table2Bean_v3(String querySql, String TableOrView, String beanName){
		Configuration cfg = new  Configuration(Configuration.VERSION_2_3_25); 
        FileOutputStream fos = null;
        /**java文件名，驼峰命名*/
        String javaFileName = "";
        ...
        try  {
        	...
        	//将整个目录下面的模板文件文件加载到templateLoad中
        	FileTemplateLoader javaBeanTemplate = new FileTemplateLoader(new File(templateLocation));
        	
//        	MultiTemplateLoader multiTemplateLoader = new MultiTemplateLoader(new TemplateLoader[]
//        			{javaBeanTemplate, xmlMapperTemplate, javaMapperTemplate, controllerMapperTemplate});
        	MultiTemplateLoader multiTemplateLoader = new MultiTemplateLoader(new TemplateLoader[]
        			{javaBeanTemplate});
            ...
            cfg.setSharedVariable("upperFC" ,  new  UpperFirstCharacter()); //添加一个"宏"共享变量用来将属性名首字母大写
            // 获取javaBean模板文件
            Template t = cfg.getTemplate(this.javaBeanTemplateName, Const.ENCODE ); //指定模板   
            ...
            // 生成mapper文件
            this.sql2Mapper_v2(querySql, propertyBeans, cfg, commonFilePath, javaFileName, baseResultMap, poPackageName);
	 ...
	 * @param cfg
	 */
	public void sql2Mapper_v2(String querySql, List<BeanProperty> propertyBeans, 
        ...
        try {
        	...
        	if(null != propertyBeans && propertyBeans.size() > 0){
        		...
        		// 获取mapper文件位置
        		Template template = cfg.getTemplate(this.xmlMapperTemplateName, Const.ENCODE);
        		// mapper文件中的namespace
        		...
        		// 生成对应的javamapper文件
        		template = cfg.getTemplate(this.javaMapperTemplateName, Const.ENCODE);
        		...
        		// 加载模板
        		template = cfg.getTemplate(this.controllerMapperTemplateName, Const.ENCODE);
